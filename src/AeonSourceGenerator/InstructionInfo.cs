...
namespace Aeon.SourceGenerator
{
    internal sealed class InstructionInfo : IEquatable<InstructionInfo>
    {
        ...
        public bool IsAffectedByOperandSize => this.Operands.IndexOfAny(new[] { OperandType.ImmediateFarPointer, OperandType.ImmediateRelativeWord, OperandType.ImmediateWord, OperandType.ImmediateByteExtend, OperandType.IndirectFarPointer, OperandType.MemoryOffsetWord, OperandType.RegisterOrMemoryWord, OperandType.RegisterOrMemoryWordNearPointer, OperandType.RegisterWord, OperandType.EffectiveAddress, OperandType.FullLinearAddress, OperandType.RegisterAX, OperandType.RegisterBX, OperandType.RegisterCX, OperandType.RegisterDX, OperandType.RegisterSI, OperandType.RegisterDI, OperandType.RegisterSP, OperandType.RegisterBP }) >= 0;
