...
internal sealed class MouseHandler(VirtualMachine vm) : IInterruptHandler
{
    ...
    IEnumerable<InterruptHandlerInfo> IInterruptHandler.HandledInterrupts => [0x33, new InterruptHandlerInfo(CallbackInterrupt, Registers.AX | Registers.BX | Registers.CX | Registers.DX | Registers.BP | Registers.SI | Registers.DI | Registers.DS | Registers.ES, false, true)];
