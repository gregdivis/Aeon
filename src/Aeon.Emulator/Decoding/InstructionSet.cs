...
public static partial class InstructionSet
{
    ...
    private static NotImplementedException GetPartiallyNotImplementedException(VirtualMachine vm, OpcodeInfo info) => new($"Instruction '{info.Name}' not implemented for {vm.Processor.AddressSize}-bit addressing, {vm.Processor.OperandSize}-bit operand size.");
...
#pragma warning disable IDE0044 // Add readonly modifier
    ...
    private static OpcodeCollection allCodes = null!;
#pragma warning restore IDE0044 // Add readonly modifier
    ...
    private readonly struct LogWriter(InstructionLog log) : ILogWriter
    {
        private readonly InstructionLog log = log;
