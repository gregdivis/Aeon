...
internal sealed class VbeHandler(VideoHandler videoHandler) : ICallbackProvider
{
    /// <summary>
    ...
    private readonly VideoHandler videoHandler = videoHandler;
    private readonly VirtualMachine vm = videoHandler.VirtualMachine;
