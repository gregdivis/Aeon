...
/// </summary>
public static partial class VirtualDirectory
{
    [GeneratedRegex($@"\A{NameExpression}\z", RegexOptions.CultureInvariant | RegexOptions.Compiled | RegexOptions.Singleline)]
    private static partial Regex LegalNameRegex();
