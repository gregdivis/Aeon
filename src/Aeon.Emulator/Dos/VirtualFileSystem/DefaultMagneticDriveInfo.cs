namespace Aeon.Emulator.Dos.VirtualFileSystem
{
    ...
    internal sealed class DefaultMagneticDriveInfo : IMagneticDrive
    {
        ...
        /// </summary>
        public static readonly DefaultMagneticDriveInfo Floppy35 = new DefaultMagneticDriveInfo
        {
            Cylinders = 80,
            Heads = 2,
            Sectors = 18,
        ...
        /// </summary>
        public static readonly DefaultMagneticDriveInfo Floppy525 = new DefaultMagneticDriveInfo
        {
            Cylinders = 80,
            Heads = 2,
            Sectors = 15,
        ...
        /// </summary>
        public static readonly DefaultMagneticDriveInfo Fixed = new DefaultMagneticDriveInfo
        {
            Cylinders = 1024,
            Heads = 16,
            Sectors = 63,
