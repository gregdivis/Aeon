...
namespace Aeon.Emulator.Instructions.Strings
{
    internal static class Stosb
    {
        ...
        [Alternate("StoreByte", AddressSize = 32, OperandSize = 16 | 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    internal static class Stosw
    {
        ...
        [Alternate("StoreWord", AddressSize = 16, OperandSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [Alternate("StoreWord", AddressSize = 32, OperandSize = 16)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [Alternate("StoreWord", AddressSize = 32, OperandSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
