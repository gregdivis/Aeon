...
namespace Aeon.Emulator.Instructions.Strings
{
    internal static class Cmpsb
    {
        ...
        [Alternate("CompareByte", OperandSize = 16 | 32, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    internal static class Cmpsw
    {
        ...
        [Alternate("CompareWord", OperandSize = 16, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [Alternate("CompareWord", OperandSize = 32, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
