...
namespace Aeon.Emulator.Instructions.Strings
{
    internal static class Lodsb
    {
        ...
        [Alternate("LoadByte", OperandSize = 16 | 32, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    internal static class Lodsw
    {
        ...
        [Alternate("LoadWord", OperandSize = 16, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [Alternate("LoadWord", OperandSize = 32, AddressSize = 16)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [Alternate("LoadWord", OperandSize = 32, AddressSize = 32)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
