...
internal readonly struct QueuedNote(int period, int periodCount) : IEquatable<QueuedNote>
{
    /// <summary>
    ...
    /// </summary>
    public int PeriodCount { get; } = periodCount;
    ...
    public override string ToString() => this == Rest ? "Rest" : $"{this.Period}, {this.PeriodCount}";
}
